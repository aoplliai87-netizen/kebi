...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    byLocale: {
        ...
        sections: [
          {
            ...
            heading: "서비스 안내",
            body:
              "도착 환승 구역(터미널)에 맞춰 미팅 가능하며, 항공편 지연 시에도 운행 시간을 조정해 드립니다. 일행·짐 양에 따라 스타리아·대형 밴 등으로 배차합니다.",
          },
          {
            id: "coverage",
            heading: "이동 가능 구역",
            body:
              "서울 전역(강남·종로·마포·영등포·송파 등) 및 주요 호텔, 비즈니스 센터까지 동선에 맞춰 운행합니다. 구체적 목적지는 예약 시 확정합니다.",
          },
          {
            id: "why",
            heading: "외국인 관광객·출장객에게 적합한 이유",
            body:
              "언어 소통이 어려운 분도 메신저(WhatsApp·카카오톡)로 일정을 남기실 수 있습니다. 정찰제 기준을 사전에 안내해 드려 예상 비용을 명확히 합니다.",
          },
        ],
        pricingIntro:
          "구간·시간대·수하물에 따라 달라지며, 아래는 상담 시 참고용 안내입니다. 최종 금액은 예약 확정 시 안내드립니다.",
        pricingItems: [
      ...
      ja: {
        ...
        pricingIntro:
          "区間・時間帯・荷物量により異なります。以下は参考例で、確定金額は予約時にご案内します。",
        pricingItems: [
        ...
        sections: [
          {
            ...
            heading: "서비스 안내",
            body:
              "회의·박람회 일정에 맞춰 도착 시간을 조정할 수 있습니다. 다수 캐리어·골프백도 사전 협의로 여유 있게 수용합니다.",
          },
          {
            id: "coverage",
            heading: "강남권 커버리지",
            body:
              "강남역·삼성역·선릉역 인근 오피스, 코엑스·무역센터 일대, 논현·신논현 등 강남 핵심 상권까지 운행합니다.",
          },
          {
            id: "why",
            heading: "추천 대상",
            body:
              "전시·컨퍼런스 방문객, 호텔 체크인 전 짐이 많은 가족, 심야 도착 후 빠른 이동이 필요한 분께 적합합니다.",
          },
        ],
