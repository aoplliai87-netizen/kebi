...
export default async function AdminInquiryPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      <h1 className="text-3xl font-bold text-tone-strong md:text-4xl">문의 비주얼 에디터</h1>
      <p className="mt-2 text-sm text-tone-body">실제 공개 `/inquiry` 화면과 동일한 컴포넌트 위에서 바로 수정합니다.</p>
      <AdminNavTabs currentPath="/admin/inquiry" reservationsCount={reservations.length} inquiriesCount={inquiries.length} />
      <div className="mt-6">
        <AdminInquiryVisualEditor
          initial={settings}
