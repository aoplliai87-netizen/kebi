  ...
  return (
    <section className="border-t border-border/45 py-16 md:py-20">
      <div className="mx-auto max-w-content px-4 md:px-6">
        <div className="rounded-2xl border border-brand-gold/20 bg-gradient-to-r from-brand-deep/75 to-surface p-6 md:p-10">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-tone-body md:text-base">
            {t("desc")}
          </p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="/review">
              <Button
                variant="outline"
                className="h-10 rounded-lg border-white/25 px-4 text-sm text-primary-foreground"
              >
                {t("ctaReview")}
              </Button>
            </a>
